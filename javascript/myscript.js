...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "dạo nài e bị đâu đầu " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
// Phần popup khi bạn nhấn vào nút "dạo nài e bị đau đầu ý"
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;e đau đầu như vậy là tại vì:';
document.querySelector('.Description .modal-body').innerHTML = 'mà cũng chẳng biết là vì gì nữa :v <i class="fas fa-heart"></i> ';
